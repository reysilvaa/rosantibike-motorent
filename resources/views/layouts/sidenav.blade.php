    ...
    <nav class="flex flex-col h-full">
        ...
        <div class="flex-1 px-4 py-6 mb-10">
            <div class="text-xs font-semibold uppercase tracking-wider mb-6 text-gray-500">Core</div>
                ...
                <a class="flex items-center px-4 py-2 bg-red-600 text-white hover:bg-red-700 rounded-md transition duration-300 ease-in-out no-underline" href="{{ route('logout') }}">
