                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="harga_perHari" id="harga_perHari"
                                   value="{{ old('harga_perHari', $jenisMotor->harga_perHari ?? '') }}"
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="foto_url" id="foto_url"
                               value="{{ old('foto_url', $jenisMotor->foto_url ?? '') }}"
            ...
            <div class="mt-8 border-t border-gray-200 pt-8">
                ...
                <div class="mt-4 bg-gray-100 p-4 rounded-lg">
                    <div id="imagePreview" class="aspect-w-16 aspect-h-9">
                        @if(isset($jenisMotor) && ($jenisMotor->foto_url || $jenisMotor->foto))
                            <img src="{{ $jenisMotor->foto_url ?: asset('storage/' . $jenisMotor->foto) }}"
                                 alt="{{ $jenisMotor->merk }}"
