    ...
    <form action="{{ route('admin.booking.update', $booking->id) }}" method="POST" class="bg-white p-6 sm:p-8 rounded-lg shadow-lg space-y-6 sm:space-y-8" id="editBookingForm">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mt-6">
            <div class="form-group">
                ...
                <input type="datetime-local" id="tgl_sewa" name="tgl_sewa" value="{{ $booking->tgl_sewa}}" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-gray-100" disabled>
            </div>

            <div class="form-group">
                <label for="tgl_kembali" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Kembali</label>
                <input type="datetime-local" id="tgl_kembali" name="tgl_kembali" value="{{ $booking->tgl_kembali}}" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('tgl_kembali') border-red-500 @enderror">
                @error('tgl_kembali')
