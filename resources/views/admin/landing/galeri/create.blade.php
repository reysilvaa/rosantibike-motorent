...
<div class="container mx-auto p-4 max-w-3xl">
    <h1 class="text-3xl font-bold mb-6 text-gray-800 text-center">Create Galeri</h1>

    <!-- Error and Success Messages (unchanged) -->
    ...
    <form x-data="{
        ...
        link_maps: '',
        localFoto: ''
    }" action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 border border-gray-200 rounded-lg shadow-lg">
        @csrf
